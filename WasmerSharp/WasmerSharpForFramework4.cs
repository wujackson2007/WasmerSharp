...
namespace WasmerSharp
{
    ...
    public class Module : WasmerNativeHandle
    {
        ...
        public static Module Create(IntPtr wasmBody, uint bodyLength)
        {
            ...
            if (wasmer_compile(out handle, wasmBody, bodyLength) == WasmerResult.Ok)
            {
        ...
        {
            if (wasmBody == null)
                throw new ArgumentException("wasmBody");
        ...
        public ExportDescriptor[] ExportDescriptors
        {
            get
            {
                ...
                IntPtr exportsHandle;
                wasmer_export_descriptors(handle, out exportsHandle);
        ...
        public Instance Instatiate(params Import[] imports)
        {
            ...
            unsafe
            {
                ...
                {
                    IntPtr result;
                    if (wasmer_module_instantiate(handle, out result, p, llimports.Length) == WasmerResult.Ok)
        ...
        public ImportDescriptor[] ImportDescriptors
        {
            get
            {
                IntPtr importsHandle;
                wasmer_import_descriptors(handle, out importsHandle);
        ...
        {
            IntPtr serialized;
            if (wasmer_module_serialize(out serialized, handle) == WasmerResult.Ok)
            {
    ...
    public class ExportFunction : WasmerNativeHandle
    {
        ...
        public WasmerValueType[] Parameters
        {
            ...
            {
                uint npars;
                if (wasmer_export_func_params_arity(handle, out npars) == WasmerResult.Error)
                    return null;
        ...
        public WasmerValueType[] Returns
        {
            ...
            {
                uint npars;
                if (wasmer_export_func_returns_arity(handle, out npars) == WasmerResult.Error)
                    return null;
                var tags = new WasmerValueType[npars];
                unsafe
                {
    ...
    public class Export : WasmerNativeHandle
    {
        ...
        public ImportExportKind Kind
        {
            get
            {
                return wasmer_export_kind(handle);
            }
        }
        ...
        public string Name
        {
            get
            {
                return wasmer_export_name(handle).ToString();
            }
        }
        ...
        public Memory GetMemory()
        {
            ...
            IntPtr mem;
            if (wasmer_export_to_memory(handle, out mem) == WasmerResult.Error)
                return null;
    ...
    public class Memory : WasmerNativeHandle
    {
        ...
        public static Memory Create(uint minPages, uint? maxPages = null)
        {
            ...
            IntPtr handle;
            if (wasmer_memory_new(out handle, limits) == WasmerResult.Ok)
            {
        ...
        public Memory(uint minPages, uint? maxPages = null)
        {
            ...
            IntPtr xhandle;
            if (wasmer_memory_new(out xhandle, limits) == WasmerResult.Ok)
                handle = xhandle;
            else
        ...
        public uint PageLength
        {
            get
            {
                return wasmer_memory_length(handle);
            }
        }
        ...
        public uint DataLength
        {
            get
            {
                return wasmer_memory_data_length(handle);
            }
        }
        ...
        public IntPtr Data
        {
            get
            {
                return wasmer_memory_data(handle);
            }
        }
        ...
        public override string ToString()
        {
            return string.Format("{0} bytes at address {1:x}", DataLength, (ulong)Data);
        }
    }
...
#pragma warning restore 649
    ...
    public class ImportDescriptor : WasmerNativeHandle
    {
        ...
        public override string ToString()
        {
            return string.Format("{0}(\"{1}::{2}\"", Kind, ModuleName, Name);
        }
    }
    ...
    public class Instance : WasmerNativeHandle
    {
        ...
        {
            if (wasm == null)
                throw new ArgumentNullException("wasm");
            if (imports == null)
                throw new ArgumentNullException("imports");
            ...
            unsafe
            {
                fixed (wasmer_import* p = &llimports[0])
                {
                    ...
                    {
                        IntPtr result;
                        if (wasmer_instantiate(out result, (IntPtr)bp, (uint)wasm.Length, p, llimports.Length) == WasmerResult.Ok)
                            handle = result;
                        else
        ...
        public Export[] Exports
        {
            ...
            {
                IntPtr exportsHandle;
                wasmer_instance_exports(handle, out exportsHandle);
        ...
        public InstanceContext Context
        {
            get
            {
                return wasmer_instance_context_get(handle);
            }
        }
    }
    ...
    public class Table : WasmerNativeHandle
    {
        ...
        public static Table Create(uint min, uint? max = null)
        {
            ...
            IntPtr handle;
            if (wasmer_table_new(out handle, limits) == WasmerResult.Ok)
        ...
        public uint Length
        {
            get
            {
                return wasmer_table_length(handle);
            }
        }
    }
    ...
    public class SerializedModule : WasmerNativeHandle
    {
        ...
        {
            IntPtr handle;
            if (wasmer_serialized_module_from_bytes(out handle, bytes, len) == WasmerResult.Ok)
        ...
        {
            IntPtr moduleHandle;
            if (wasmer_module_deserialize(out moduleHandle, handle) == WasmerResult.Ok)
    ...
    public struct InstanceContext
    {
        ...
        public object Data
        {
            get
            {
                return GCHandle.FromIntPtr(wasmer_instance_context_data_get(Handle));
            }
        }
